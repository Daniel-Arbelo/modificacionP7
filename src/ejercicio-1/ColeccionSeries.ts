 ...
 */
export class ColeccionSeries extends BasicStreamableCollection {
    /**
     ...
     */
    constructor(protected conjuntoTitulos: Serie[]){
    ...
    busquedaPorAno(fecha:number): Titulo[] {
        ...
        console.table(sol,  ["nombre", "duracion", "ano", "precio", "numeroTemporadas"]);
        return sol;
    }
